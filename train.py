...
if __name__ == "__main__":
    ...
    trainset = CIFAR10(
        "./cifar10-train", transform=transform_train, train=True, download=True,
    )
    ...
    testset = CIFAR10(
        "./cifar10-test", transform=transform_test, train=False, download=True,
    )
    ...
    for epoch in range(300):
        ...
        if epoch == 0:
            optimizer = optim.SGD(
                model.parameters(), lr=1e-1, weight_decay=4e-5, momentum=0.9
            )
        elif epoch == 150:
            optimizer = optim.SGD(
                model.parameters(), lr=1e-2, weight_decay=4e-5, momentum=0.9
            )
        elif epoch == 225:
            optimizer = optim.SGD(
                model.parameters(), lr=1e-3, weight_decay=4e-5, momentum=0.9
            )
